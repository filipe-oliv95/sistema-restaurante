package com.restaurante.marmitas.constants;
...
public class ProdutoConstants {
    ...
    public static final String PRECO_NOT_NULL = "O preço não pode ser nulo.";
    public static final String PRECO_POSITIVE = "O preço deve ser maior que zero.";
}
