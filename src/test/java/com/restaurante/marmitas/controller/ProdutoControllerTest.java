...
class ProdutoControllerTest {
    ...
    void updateProduto_deveRetornarStatus200QuandoProdutoForAtualizadoComSucesso() throws Exception {
        ...
        // Simula o comportamento do serviço para encontrar o produto e atualizar com sucesso
        when(iProdutoService.updateProduto(produtoRequestDto, produtoId)).thenReturn(true);
